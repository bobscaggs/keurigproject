...
void handleOutput() {
  ...
  // I am assuming I can use pin 8 here
  toSend.isSixOzButtonPressed =
    toSend.isSixOzButtonPressed | ((PIND >> 8) & 1);
...
void handleInput() {
  ...
  if(commandCounter > 0) {
    ...
    switch(Serial.read()) {
      ...
      break;
      case 's':
        // Press the 6oz brew button (Pin 8)
        PORTB = (1<<1);
        DDRB = (1<<1);
        commandCounter = 1;
      break;
